...
fun EmployerWorkScreen(
    ...
    val items = listOf(
        ...
        BottomNavItem(route = Screen.MyAdvertisements.route, icon = R.drawable.ic_profile), //поставить избранные
            ...
            Row(
                ...
                Box(
                    modifier = Modifier
                        ...
                        .background(color = TransparentWhite, shape = RoundedCornerShape(32.dp)),
